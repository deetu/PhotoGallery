...
public class FlickrFetchr {
    private static final String API_KEY = "9e2dbccc570fab36d786bdbb7001fa85";
...
//            parseItems(items, jsonObject);
            items = parseGSONItems(jsonObject);
    ...
    @NonNull
    private List<GalleryItem> parseGSONItems(JSONObject jsonObject) throws JSONException{
